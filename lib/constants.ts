...
export const SERVICES = [
  ...
  },
  {
    ...
    title: 'SEO Services',
    icon: 'Search',
    short: 'Improve search rankings and drive qualified organic traffic.',
    description:
      'Our SEO strategies focus on technical SEO, content optimization, local SEO, keyword research, backlink development, and performance monitoring to increase your visibility on Google and generate long-term traffic growth.',
    benefits: [
  ...
  },
  {
    ...
    icon: 'Megaphone',
    short: 'High-converting PPC campaigns focused on ROI.',
    description:
      'We manage Google Search, Display, Shopping, and Performance Max campaigns to generate leads and sales while maximizing return on ad spend.',
    benefits: [
      'Search campaigns',
      'Display campaigns',
      'Conversion tracking',
  ...
  },
  {
    ...
    icon: 'BadgePercent',
    short: 'Facebook and Instagram advertising campaigns.',
    description:
      'Targeted Meta advertising strategies designed to generate leads, sales, engagement, and brand awareness across Facebook and Instagram.',
    benefits: [
      'Facebook Ads',
      'Instagram Ads',
      'Retargeting',
  ...
  },
  {
    ...
    icon: 'Gauge',
    short: 'Data-driven campaigns with measurable business outcomes.',
    description:
      'We create and optimize performance marketing campaigns across multiple channels to maximize conversions, revenue, and customer acquisition.',
    benefits: [
  ...
  },
  {
    ...
    icon: 'Users',
    short: 'Build your brand across social platforms.',
    description:
      'Strategic social media planning, content creation, audience engagement, and campaign management for sustainable brand growth.',
    benefits: [
      'Content planning',
      'Creative design',
  ...
  },
  {
    ...
    icon: 'PanelTop',
    short: 'Conversion-focused landing pages.',
    description:
      'We create highly optimized landing pages designed to improve lead generation and increase advertising campaign performance.',
    benefits: [
  ...
  },
  {
    ...
    icon: 'Palette',
    short: 'Professional creative assets for digital and print.',
    description:
      'Branding, brochures, social media creatives, corporate presentations, banners, and marketing materials.',
    benefits: [
      'Social creatives',
      'Brand materials',
      'Brochure design',
  ...
  },
  {
    ...
    title: 'Video Editing',
    icon: 'Sparkles',
    short: 'Professional editing for marketing and corporate videos.',
    description:
      'High-quality video production, editing, reels, promotional videos, explainer videos, and motion graphics.',
    benefits: [
      'Corporate videos',
      'Instagram reels',
      'Motion graphics',
  ...
  },
  {
    ...
    icon: 'Database',
    short: 'Transform business data into actionable insights.',
    description:
      'Advanced analytics services that help organizations make better decisions through data-driven insights.',
    benefits: [
      'Business analytics',
      'Data modeling',
      'Forecasting',
  ...
  },
  {
    ...
    icon: 'Gauge',
    short: 'Power BI and Tableau dashboards.',
    description:
      'Executive dashboards, KPI monitoring, automated reporting, and business intelligence solutions.',
    benefits: [
      'Power BI',
      'Tableau',
  ...
  },
  {
    ...
    icon: 'PanelTop',
    short: 'Interactive dashboards and reports.',
    description:
      'Transform complex datasets into visually engaging dashboards and actionable reports.',
    benefits: [
  ...
  },
  {
    ...
    icon: 'Brain',
    short: 'Forecast future business outcomes.',
    description:
      'Leverage machine learning and statistical models to predict trends, customer behavior, and business opportunities.',
    benefits: [
      'Demand forecasting',
      'Customer prediction',
      'Risk analysis',
